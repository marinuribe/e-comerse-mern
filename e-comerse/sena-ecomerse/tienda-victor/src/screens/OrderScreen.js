...
export default function OrderScreen() {
  ...
  return loading ? (
    ...
    <div>
      <Helmet>
        <title>Numero de orden {orderId}</title>
      </Helmet>
      <h1 className="my-3">Numero de orden {orderId}</h1>
      <Row>
        <Col md={8}>
          <Card className="mb-3">
            <Card.Body>
              <Card.Title>Información de envio</Card.Title>
              <Card.Text>
            ...
            <Card.Body>
              ...
              <ListGroup variant="flush">
                <ListGroup.Item>
                  <Row>
                    <Col>Productos</Col>
                    <Col>${order.itemsPrice.toFixed(2)} COP</Col>
                    </Row>
                </ListGroup.Item>
                <ListGroup.Item>
                  <Row>
                    <Col>Envio</Col>
                    <Col>${order.shippingPrice.toFixed(2)} COP</Col>
                  </Row>
                </ListGroup.Item>
                <ListGroup.Item>
                  <Row>
                    <Col>Impuestos</Col>
                    <Col>${order.taxPrice.toFixed(2)} COP</Col>
                  </Row>
                </ListGroup.Item>
                <ListGroup.Item>
                  <Row>
                    ...
                    <Col>
                      <strong>${order.totalPrice.toFixed(2)} COP</strong>
                    </Col>
                  </Row>
                </ListGroup.Item>
              </ListGroup>
